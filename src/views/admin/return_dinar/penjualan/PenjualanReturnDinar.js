                ...
                {penjualans.length > 0 ? (
                  penjualans.map((penjualan, index) => (
                    <tr key={index}>
                      ...
                      <td className="py-2 px-3">{penjualan.barcode_penjualan}</td>
                      <td className="w-[15%] py-2 px-3">{penjualan.unit}</td>
                      <td className="py-2 px-3">{penjualan.harga_beli}</td>
                      <td className="py-2 px-3">{penjualan.harga_jual}</td>
                      <td className="py-2 px-3">{penjualan.harga_jual}</td>
                      <td className="py-2 px-3">{penjualan.harga_jual}</td>
                    </tr>
                  ))
