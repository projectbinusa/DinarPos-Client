...
import { API_SALESMAN, GET_TRANSAKSI_JUAL, KONFIRMASI_365 } from "../../../../utils/BaseUrl";

function Konfirmasi365Dinarpos() {
  ...
  const konfirmasi = async (e) => {
    ...
    await axios
      .put(`${KONFIRMASI_365}/` + param.id, request, {
        headers: { "auth-tgh": `jwt ${localStorage.getItem("token")}` },
      })
      .then(() => {
        Swal.fire({
        ...
        history.push("/notifikasi_365_dinarpos");
        setTimeout(() => {
        ...
        <div className="flex flex-col items-start lg:flex-row lg:items-center lg:justify-between">
          ...
          <Breadcrumbs className="bg-transparent">
            ...
            <a href="/notifikasi_365_dinarpos">
              <span>Notifikasi 365 Hari Dinarpos</span>
            </a>
...
export default Konfirmasi365Dinarpos;
