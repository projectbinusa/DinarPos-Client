  ...
  const konfirmasi = async (e) => {
    ...
    await axios
      ...
      .then(() => {
        ...
        history.push("/notifikasi_30_dinarpos");
        setTimeout(() => {
        ...
        <div className="flex flex-col items-start lg:flex-row lg:items-center lg:justify-between">
          ...
          <Breadcrumbs className="bg-transparent">
            ...
            <a href="/notifikasi_30_dinarpos">
              <span>Notifikasi 30 Hari Dinarpos</span>
            </a>
...
export default Konfirmasi30Dinarpos;
