...
function Konfirmasi120Dinarpos() {
  ...
  const konfirmasi = async (e) => {
    ...
    await axios
      .put(`${KONFIRMASI_120}/` + param.id, request, {
        headers: { "auth-tgh": `jwt ${localStorage.getItem("token")}` },
      })
      .then(() => {
        Swal.fire({
        ...
        history.push("/notifikasi_120_dinarpos");
        setTimeout(() => {
        ...
        <div className="flex flex-col items-start lg:flex-row lg:items-center lg:justify-between">
          ...
          <Breadcrumbs className="bg-transparent">
            ...
            <a href="/notifikasi_120_dinarpos">
              <span>Notifikasi 120 Hari Dinarpos</span>
            </a>
...
export default Konfirmasi120Dinarpos;
