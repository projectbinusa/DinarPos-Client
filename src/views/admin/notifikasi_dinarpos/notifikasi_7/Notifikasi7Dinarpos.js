...
import {
  ...
  NOTIFIKASI_7_DINARPOS,
  NOTIFIKASI_KONFIRMASI_7_DINARPOS,
} from "../../../../utils/BaseUrl";
...
function Notifikasi7Dinarpos() {
  ...
  // GET KONFIRMASI 7 HARI DINARPOS
  const getAllKonfirmasi = async () => {
    try {
      const response = await axios.get(`${NOTIFIKASI_KONFIRMASI_7_DINARPOS}`, {
        headers: { "auth-tgh": `jwt ${localStorage.getItem("token")}` },
      });
        ...
        <div className="flex flex-col items-start lg:flex-row lg:items-center lg:justify-between">
          ...
          <Breadcrumbs className="bg-transparent">
            ...
            <a href="/notifikasi_7_dinarpos">
              <span>Notifikasi 7 Dinarpos</span>
            </a>
          </Breadcrumbs>
        </div>
                    ...
                    return (
                      <tr key={index}>
                        ...
                        <td className="text-sm py-2 px-3 flex justify-center items-center gap-2">
                          ...
                          <a
                            href={
                              "/konfirmasi_7_dinarpos/" + penjualan.idTransaksi
                            }
                          >
