...
function Konfirmasi365Excelcom() {
  ...
  const konfirmasi = async (e) => {
    ...
    await axios
      ...
      .then(() => {
        ...
        history.push("/notifikasi_365_excelcom");
        setTimeout(() => {
        ...
        <div className="flex flex-col items-start lg:flex-row lg:items-center lg:justify-between">
          ...
          <Breadcrumbs className="bg-transparent">
            ...
            <a href="/notifikasi_365_excelcom">
              <span>Notifikasi 365 Hari Excelcom</span>
            </a>
...
export default Konfirmasi365Excelcom;
