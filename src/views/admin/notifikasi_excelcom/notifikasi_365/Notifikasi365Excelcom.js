...
function Notifikasi365Excelcom() {
  ...
  const getAll = async () => {
    try {
      const response = await axios.get(`${NOTIFIKASI_365_EXCELCOM}`, {
      ...
      <div className="lg:ml-[18rem] ml-0 pt-24 lg:pt-5 w-full px-5 overflow-x-auto">
        <div className="flex flex-col items-start lg:flex-row lg:items-center lg:justify-between">
          <Typography variant="lead" className="uppercase">
            KETERANGAN NOTIFIKASI 365 HARI EXCELCOM
          </Typography>
          <Breadcrumbs className="bg-transparent">
            ...
            <a href="/notifikasi_365_excelcom">
              <span>Notifikasi 365 Excelcom</span>
            </a>
          </Breadcrumbs>
        </div>
...
export default Notifikasi365Excelcom;
