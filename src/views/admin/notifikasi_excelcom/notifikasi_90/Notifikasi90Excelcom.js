...
import {
  ...
  NOTIFIKASI_90_EXCELCOM,
  NOTIFIKASI_KONFIRMASI_90_EXCELCOM,
} from "../../../../utils/BaseUrl";

function Notifikasi90Excelcom() {
  ...
  const getAll = async () => {
    try {
      const response = await axios.get(`${NOTIFIKASI_90_EXCELCOM}`, {
  ...
  const getAllKonfirmasi = async () => {
    try {
      const response = await axios.get(`${NOTIFIKASI_KONFIRMASI_90_EXCELCOM}`, {
        headers: { "auth-tgh": `jwt ${localStorage.getItem("token")}` },
      });
      ...
      <div className="lg:ml-[18rem] ml-0 pt-24 lg:pt-5 w-full px-5">
        <div className="flex flex-col items-start lg:flex-row lg:items-center lg:justify-between">
          <Typography variant="lead" className="uppercase">
            KETERANGAN NOTIFIKASI 90 HARI EXCELCOM
          </Typography>
          <Breadcrumbs className="bg-transparent">
            ...
            <a href="/notifikasi_90_excelcom">
              <span>Notifikasi 90 Excelcom</span>
            </a>
          </Breadcrumbs>
        </div>
                    ...
                    return (
                      <tr key={index}>
                        ...
                        <td className="text-sm py-2 px-3 flex gap-2 items-center justify-center">
                          ...
                          <a
                            href={
                              "/konfirmasi_90_excelcom/" + penjualan.idTransaksi
                            }
                          >
        ...
        <main className="bg-white shadow-lg p-5 my-5 rounded">
          <Typography variant="lead" className="uppercase">
            KONFIRMASI NOTIFIKASI 90 HARI EXCELCOM
          </Typography>
...
export default Notifikasi90Excelcom;
