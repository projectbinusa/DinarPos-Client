...
import { API_SALESMAN, GET_TRANSAKSI_JUAL, KONFIRMASI_90 } from "../../../../utils/BaseUrl";
import axios from "axios";
import { useHistory, useParams } from "react-router-dom/cjs/react-router-dom.min";
import SidebarAdmin from "../../../../component/SidebarAdmin";

function Konfirmasi90Excelcom() {
  ...
  const konfirmasi = async (e) => {
    ...
    await axios
      .put(`${KONFIRMASI_90}/` + param.id, request, {
        headers: { "auth-tgh": `jwt ${localStorage.getItem("token")}` },
      })
      .then(() => {
        Swal.fire({
        ...
        history.push("/notifikasi_90_excelcom");
        setTimeout(() => {
        ...
        <div className="flex flex-col items-start lg:flex-row lg:items-center lg:justify-between">
          ...
          <Breadcrumbs className="bg-transparent">
            ...
            <a href="/notifikasi_90_excelcom">
              <span>Notifikasi 90 Hari Excelcom</span>
            </a>
...
export default Konfirmasi90Excelcom;
