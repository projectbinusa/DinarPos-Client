...
import { NOTIFIKASI_30_EXCELCOM } from "../../../../utils/BaseUrl";
...
function Notifikasi30Excelcom() {
  ...
  const getAll = async () => {
    try {
      const response = await axios.get(`${NOTIFIKASI_30_EXCELCOM}`, {
      ...
      <div className="lg:ml-[18rem] ml-0 pt-24 lg:pt-5 w-full px-5">
        <div className="flex flex-col items-start lg:flex-row lg:items-center lg:justify-between">
          <Typography variant="lead" className="uppercase">
            KETERANGAN NOTIFIKASI 30 HARI EXCELCOM
          </Typography>
          <Breadcrumbs className="bg-transparent">
            ...
            <a href="/notifikasi_30_excelcom">
              <span>Notifikasi 30 Excelcom</span>
            </a>
          </Breadcrumbs>
        </div>
...
export default Notifikasi30Excelcom;
