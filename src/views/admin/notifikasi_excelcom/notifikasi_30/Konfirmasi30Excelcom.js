...
import { API_SALESMAN, GET_TRANSAKSI_JUAL, KONFIRMASI_30 } from '../../../../utils/BaseUrl';
import axios from 'axios';
import Swal from 'sweetalert2';
import { useHistory, useParams } from 'react-router-dom/cjs/react-router-dom.min';

function Konfirmasi30Excelcom() {
  ...
  const konfirmasi = async (e) => {
    ...
    await axios
      .put(`${KONFIRMASI_30}/` + param.id, request, {
        headers: { "auth-tgh": `jwt ${localStorage.getItem("token")}` },
      })
      .then(() => {
        Swal.fire({
        ...
        history.push("/notifikasi_30_excelcom");
        setTimeout(() => {
        ...
        <div className="flex flex-col items-start lg:flex-row lg:items-center lg:justify-between">
          ...
          <Breadcrumbs className="bg-transparent">
            ...
            <a href="/notifikasi_30_excelcom">
              <span>Notifikasi 30 Hari Excelcom</span>
            </a>
...
export default Konfirmasi30Excelcom