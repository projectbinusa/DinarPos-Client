  ...
  const openWhatsapp = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const whatsappURL = `https://api.whatsapp.com/send?phone=${reportData.customer.telp}&text=Terimakasih%20Kak%20${reportData.customer.nama_customer}%20Telah%20Berbelanja%20di%20Excellent%20Computer`;
