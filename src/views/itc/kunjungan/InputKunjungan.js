                                ...
                                {customerId2 !== 0 ? (<>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                        <Input variant="static"
                                            color="blue"
                                            size="lg" readOnly
                                            label="Nama Customer" value={`${customer.nama} ( terakhir diperbaharui : ${customer.terakhir_update} )`} />
                                        <Input variant="static"
                                            color="blue"
                                            size="lg" readOnly
                                        ...
                                        <Input variant="static"
                                            color="blue"
                                            size="lg"
                                            label="Tujuan" onChange={(e) => settujuan(e.target.value)} />
                                        <Select
                                            variant="static"
                                            color="blue"
                                            size="lg"
                                        ...
                                        <Input variant="static"
                                            color="blue"
                                            size="lg"
                                            label="Deal" placeholder="Deal (%) / Presentase Proses" onChange={(e) => setdeal(e.target.value)} />
                                        <Input variant="static"
                                            color="blue"
                                            size="lg"
                                            label="Pembayaran" placeholder="Pembayaran (%)" onChange={(e) => setpembayaran(e.target.value)} />
                                        <div>
                                            <Textarea
                                                color="blue"
                                                variant="static"
                                        ...
                                        <Input variant="static"
                                            color="blue"
                                            size="lg"
                                            label="Peluang" placeholder="Peluang" onChange={(e) => setpeluang(e.target.value)} />
                                        <Input variant="static"
                                            color="blue"
                                            size="lg"
                                            label="Tanggal Deal" type="date" onChange={(e) => settglDeal(e.target.value)} />
                                        <Input variant="static"
                                            color="blue"
                                            size="lg"
                                            label="Foto" type="file" accept="image/*"
                                            onChange={(e) =>
                                        ...
                                        >
                                            <thead className="bg-blue-500 text-white">
                                                <tr>
                                                    ...
                                                    <th className="text-sm py-2 px-3 font-semibold">CV</th>
                                                    <th className="text-sm py-2 px-3 font-semibold">Visit</th>
                                                    <th className="text-sm py-2 px-3 font-semibold">Tipe</th>
